...
with open('prep_apo4holoref_antechamber.in', 'w') as f:
    ...
    f.write('mol = loadpdb apo_continue_halfdS4holoref.pdb\n')
    ...
    f.write('savepdb mol apo_continue4holoref.pdb\n')
    f.write('saveamberparm mol apo_continue4holoref.prmtop apo_continue4holoref.inpcrd\n')
    f.write('quit\n')
...
with open(f'apo_continue_halfdS4holoref.pdb', 'w') as f:
